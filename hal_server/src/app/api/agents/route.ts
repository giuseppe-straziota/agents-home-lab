...
export async function GET() {
    try {
        ...
        const result_llm = await pool.query('SELECT  a.name , a.uuid as agent_uuid, l.name as llm_name, l.uuid as llm_uuid , al.config as llm_config  FROM agent a  join agent_llm al ON al.id_agent = a.id join llm l on al.id_llm = l.id ')
